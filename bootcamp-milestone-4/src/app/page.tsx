      ...
      <main className="px-5 pt-5 pb-5">
        ...
        <div className="about">
          <div className="about-image">
            <img src="/images/akpsi.jpeg" alt="My Professional Headshot" />
          </div>
